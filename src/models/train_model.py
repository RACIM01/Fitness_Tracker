...
)  # stratify=y to keep the same distribution of labels in the train and test set


# check the distribution of the labels in the train and test set
...
print("time_feature: ", len(time_features))
...
# saved the results to a list to save time when re-running the notebook
...
possible_feature_sets = [
    ...
    feature_set_3,
    feature_set_4,
    selected_features,  # forward feature selection results
]
...
# --------------------------------------------------------------
# feature_set_4 has the best results for almost all models but for the decision tree selected_features is better
